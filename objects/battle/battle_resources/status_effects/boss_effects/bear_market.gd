extends CogAttack
class_name BearMarket

const EFFECT_BEAR_MARKET := preload('res://objects/battle/battle_resources/status_effects/resources/status_effect_auditor_bear_market.tres')
...
func apply_effect() -> void:
	var new_effect := EFFECT_BEAR_MARKET.duplicate()
